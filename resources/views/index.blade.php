...
<section class="bg-white dark:bg-gray-900 tracking-tight leading-normal">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-20 lg:px-12">

        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Check your CASURECO II Bill</h1>
        ...
        {!! Form::open(['action' => 'HomeController@search', 'method' => 'GET']) !!} <!-- Post Method-->
            <div class="flex sm:flex-row flex-col justify-between w-full mx-auto">
                <div class="w-full text-left px-2">
                    ...
                    <input type="tel" name="acct_no" id="acct_no" placeholder="ex. 123456" maxlength="6" class="mb-2 flex block w-full p-4 sm:mx-1 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
