...
@section('content')
<div class="py-8 lg:px-24 mx-auto bg-gray-100 dark:b">
    <div class="px-4 sm:px-0">
      <h3 class="text-xl lg:text-4xl font-semibold lg:font-extrabold lg:mb-4 leading-7 text-gray-900">Applicant Information</h3>
    ...
    <div class="mt-6 border-t border-gray-100">
      <dl class="divide-y divide-gray-100">
        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{$bill_query->route_code}}</dd>
        </div>
        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
