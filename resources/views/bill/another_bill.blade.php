    <!-- Invoice -->
    <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10" id="bill">
      <div class="sm:w-11/12 lg:w-3/4 mx-auto">
        ...
        <div class="flex flex-col p-4 sm:p-10 bg-white shadow-md rounded-xl dark:bg-gray-800">
          ...
          <div class="mt-8 grid sm:grid-cols-2 gap-3">
            <div>
              ...
              <h3 class="text-lg font-semibold text-gray-500 dark:text-gray-400">Bill Month:</h3>
        ...
        <!-- Buttons -->
        <div class="hidden mt-6 flex justify-end gap-x-3">
