<footer class="text-gray-600 body-font bg-white dark:bg-gray-900  pt-2">
    <div class="px-5 py-4 mx-auto flex items-center sm:flex-row flex-col shadow">
      ...
      <span class="inline-flex sm:ml-auto sm:mt-0 mt-4  ">
        <a class="text-gray-500" href="https://www.facebook.com/CASURECOII">
      ...
      @php
        $year = date("Y"); 
      @endphp
      <span class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">CASURECO II © {{$year}} </span>
